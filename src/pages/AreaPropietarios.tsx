...
import { ArrowLeft, Eye, EyeOff, CheckCircle, TrendingUp, FileText, Wrench, Users } from 'lucide-react'
...
export default function AreaPropietarios() {
  ...
  const features: string[] = t('auth.features_prop', { returnObjects: true }) as string[]
      ...
      <div className="relative z-10 w-full flex flex-col lg:flex-row">
        ...
        <div className="hidden lg:flex flex-col justify-center px-16 xl:px-24 py-24 lg:w-5/12 xl:w-1/2">
          <div className="max-w-md">
            <p className="label text-white/35 mb-4">{t('auth.propietarios_label')}</p>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-24 lg:py-0">
          <div className="w-full max-w-[400px]">
            ...
            <div className="lg:hidden text-center mb-8">
              <p className="label text-white/35 mb-3">{t('auth.propietarios_label')}</p>
              <h1 className="font-cormorant font-semibold text-white text-3xl">{t('auth.propietarios_title')}</h1>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-[0_24px_80px_rgba(0,0,0,0.35)]">
              ...
              {tried ? (
                ...
                <>
                  <div className="mb-7">
                    <h2 className="font-inter font-bold text-navy text-lg mb-1">{t('auth.propietarios_label')}</h2>
